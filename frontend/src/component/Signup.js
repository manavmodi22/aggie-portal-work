    ...
    return (
        <>
            <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', height: '100vh', backgroundColor: '#500001' }}>
                ...
                <div style={{ width: '530px', backgroundColor: 'white', display: 'flex', flexDirection: 'column', alignItems: 'center', padding: '30px', borderRadius: '5px' }}>
                    <TextField
                    ...
                    />
                    <Button variant="contained" style={{ width: '400px', height: '60px', backgroundColor:'#500001', color: 'white', borderRadius: '5px' }} onClick={handleSignup}>
                        Sign Up
                    </Button>
                </div>
            </div>
