                ...
                <tr key={user._id}>
                  ...
                  <td>{getRoleString(user.role)}</td>
                    ...
                    <div className="button-group">
                        ...
                        <Button className="button" onClick={() => handleStatusClick(user)}>Change Status</Button>
                        <Button className="button" onClick={() => handleDeleteClick(user._id)}>Delete</Button>
                    </div>
                    </td>
